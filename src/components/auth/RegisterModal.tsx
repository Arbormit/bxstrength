...
import { X, Lock, Mail, User, Phone, Dumbbell, AlertCircle, ArrowRight, ShieldCheck, Eye, EyeOff } from 'lucide-react';
...
export const RegisterModal: React.FC<RegisterModalProps> = ({
  ...
  const handleGoogleSignUp = async () => {
    try {
      ...
      setError(null);
      const googleUser = await loginWithGoogle('athlete.google@gmail.com', 'Alex Vance (Google Account)');
      onClose();
      if (onSuccessNavigate) {
      ...
      <div className="relative w-full max-w-md bg-[#121214] text-white border border-zinc-800 shadow-2xl rounded-xl overflow-hidden font-sans max-h-[90vh] flex flex-col">
        ...
        <div className="p-6 sm:p-8 space-y-4 overflow-y-auto">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-[11px] font-black tracking-widest text-zinc-400 uppercase">
                JOIN BxStrength LUXURY FITNESS
              </span>
            </div>
            ...
            <p className="text-xs text-zinc-400">
              Sign up to access body stats tracking, workout routines, and class scheduling.
            </p>
          </div>
          ...
          >
            ...
            <span>{googleLoading ? 'REGISTERING WITH GOOGLE...' : 'SIGN UP WITH GOOGLE'}</span>
          </button>
