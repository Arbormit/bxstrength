      ...
      <div className="relative w-full max-w-md bg-[#121214] text-white border border-zinc-800 shadow-2xl rounded-xl overflow-hidden font-sans max-h-[90vh] flex flex-col">
        ...
        <div className="p-6 sm:p-8 space-y-4 overflow-y-auto">
          ...
          >
            ...
            <span>{googleLoading ? 'LAUNCHING GOOGLE AUTH...' : 'SIGN UP WITH GOOGLE'}</span>
          </button>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#18181b] border border-zinc-800 focus:border-zinc-600 text-white pl-10 pr-4 py-2.5 text-xs font-bold rounded-lg outline-none"
                />
              </div>
            </div>
