...
import { Dumbbell, MapPin, Mail, ArrowRight, Shield, FileText, Lock } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 pb-12 border-b border-zinc-800">
          ...
          <div className="space-y-4">
            ...
            <div className="text-xs text-zinc-400 space-y-1 pt-1 font-medium">
              ...
              <p className="flex items-center gap-1.5"><Mail className="w-3.5 h-3.5 text-zinc-500" /> admin@bxstrength.com</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <button onClick={() => handleNav('terms')} className="hover:text-white transition-colors flex items-center gap-1.5 font-bold text-zinc-300">
                  <FileText className="w-3.5 h-3.5 text-zinc-500" /> Terms & Conditions
                </button>
              </li>
              <li>
                <button onClick={() => handleNav('privacy')} className="hover:text-white transition-colors flex items-center gap-1.5 font-bold text-zinc-300">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-400">
          ...
          <div className="flex items-center gap-4 text-xs">
            ...
            <span>•</span>
            <span className="text-zinc-400">admin@bxstrength.com</span>
          </div>
        </div>
