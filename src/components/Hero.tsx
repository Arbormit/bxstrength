...
export const Hero: React.FC<HeroProps> = () => {
  ...
  return (
    <section id="main-content" className="relative w-full h-[85vh] min-h-[500px] max-h-[900px] bg-[#0a0a0a] overflow-hidden flex items-end justify-start border-b border-zinc-800 font-sans pb-10 sm:pb-14">
      ...
      <img
        ...
        className="absolute inset-0 w-full h-full object-cover object-center filter brightness-[0.85] contrast-105"
      />

      {/* Atmospheric Gradient Vignette for seamless header/footer integration */}
      <div className="absolute inset-0 bg-gradient-to-t from-[#0a0a0a] via-black/30 to-black/60 pointer-events-none" />
